...
<link href="/InstaKgram/assets/css/board.css" rel="stylesheet" type="text/css">
</head>
<body>
	<div id="container">
		<div id="header">
		...
		<div id="content">
			<div id="board">
				<form class="board-form" method="post" action="/InstaKgram/board/modify">
					...
					<div class="bottom">
						<a href="/InstaKgram/board/view?no=${list.no}">취소</a>
